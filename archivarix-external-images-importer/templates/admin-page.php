	...
	<div class="aeii-admin-container">
		...
		<div id="statistics" class="aeii-tab-content">
			...
			<div class="aeii-logs-toolbar">
				...
				<label><?php esc_html_e( 'Filter:', 'archivarix-external-images-importer' ); ?> <select id="aeii-logs-filter"><option value="all"><?php esc_html_e( 'All results', 'archivarix-external-images-importer' ); ?></option><option value="downloaded"><?php esc_html_e( 'Downloaded', 'archivarix-external-images-importer' ); ?></option><option value="cached"><?php esc_html_e( 'Cached / Existing', 'archivarix-external-images-importer' ); ?></option><option value="failed"><?php esc_html_e( 'Failed', 'archivarix-external-images-importer' ); ?></option><option value="removed"><?php esc_html_e( 'Removed', 'archivarix-external-images-importer' ); ?></option><option value="placeholder"><?php esc_html_e( 'Placeholder', 'archivarix-external-images-importer' ); ?></option></select></label>
